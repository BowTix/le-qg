...
import { ArrowLeft, Plus, Trash2, Edit3, Save, X, BookOpen, HelpCircle } from 'lucide-react';
              ...
              {packs.map(p => (
                ...
                >
                  <div>
                    ...
                    <span style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>{p.question_count} questions</span>
                  </div>
